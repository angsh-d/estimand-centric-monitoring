      ...
      <div className="h-14 border-b border-slate-100 bg-white flex items-center justify-between px-6 shrink-0 z-10">
         ...
         <div className="flex items-center gap-3">
           ...
           <Button 
             variant="outline" 
             size="sm" 
             className="h-8 text-[11px] font-medium border-slate-200 flex items-center gap-2 text-slate-700 hover:text-black hover:border-slate-300 transition-colors"
             onClick={() => setLocation("/study/site-dossier/109")}
           >
             <Building2 className="h-3.5 w-3.5" /> View Site Dossier
           </Button>
           
           <Button size="sm" className="h-8 text-[11px] font-medium bg-slate-900 text-white hover:bg-slate-800">
